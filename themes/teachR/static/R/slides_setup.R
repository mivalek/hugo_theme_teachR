knitr::opts_chunk$set(echo = FALSE, global.par = TRUE, warning = FALSE, message = FALSE, fig.height = 3, dpi = 300, dev.args = list(bg = 'transparent'))
...
ggplot2::update_geom_defaults("bar", list(fill = "transparent", colour = default_col))
